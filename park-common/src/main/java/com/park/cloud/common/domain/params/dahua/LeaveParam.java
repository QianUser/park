...
@Data
public class LeaveParam extends CommParam {
    /**
     ...
     * 金额优惠集合
     */
    private List<DiscountMoney> discountMoney;

    /**
     * 折扣优惠集合，当前为null
     */
    private List<DiscountRate> discountRate;

    /**
     * 时间优惠集合，当前为null
     */
    private List<DiscountTime> discountTime;
    ...
    /**
     * 支付类型：0、现金支付，3、手机支付。线上开闸返回3，其他返回0
     */
