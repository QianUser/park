 ...
 *
 * @author liuhainan
 * @createDate 2020/04/15 15:30
 */
@Data
public class RefundBargainOrderVO {
    ...
    @ApiModelProperty(value = "订单状态（1：进行中，2：已完成")
    ...
    @ApiModelProperty(value = "支付者停车号")
    private String payParkUserId;

    @ApiModelProperty(value = "用户申请时长")
    private Integer applyDuration;

    @ApiModelProperty(value = "缴费/续费金额（分）")
    private Integer payPrice;

    @ApiModelProperty(value = "支付单支付方式")
    private Integer payPayType;

    @ApiModelProperty(value = "支付模式：0、用户主动缴费 1、商户主动收钱")
    private Integer payMethod;

    @ApiModelProperty(value = " 用户申请时间")
    private LocalDateTime applyInTime;

    @ApiModelProperty(value = " 扣费成功时间/订单记录时间")
    private LocalDateTime paymentTime;

    @ApiModelProperty(value = " 缴费订单编号")
    private String paymentCode;

    @ApiModelProperty(value = " 第三方支付网关交易流水号（微信支付，支付宝）")
    private String payerTradeNo;

    @ApiModelProperty(value = " 状态（1：未退费 2：已退费)")
